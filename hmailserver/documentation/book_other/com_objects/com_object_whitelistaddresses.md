...
<div class="api_method_name"><a href="?page=com_object_whitelistaddress">WhiteListAddress</a> Item(long Index)</div>

<div class="api_description">Returns an object by its given index.<br> <i>(read-only)</i></div>

<div class="api_method_name"><a href="?page=com_object_whitelistaddress">WhiteListAddress</a> ItemByDBID(long DBID)</div>
