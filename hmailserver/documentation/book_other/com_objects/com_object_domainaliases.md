...
The DomainAliases object is a collection of all domain name aliases set up for a specific domain.
...
<div class="api_method_name"><a href="?page=com_object_domainalias">DomainAlias</a> Item(long Index)</div>

<div class="api_description">Item<br> <i>(read-only)</i></div>

<div class="api_method_name"><a href="?page=com_object_domainalias">DomainAlias</a> ItemByDBID(long DBID)</div>
