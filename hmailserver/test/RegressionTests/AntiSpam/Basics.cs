...
namespace RegressionTests.AntiSpam
{
   ...
   public class Basics : TestFixtureBase
   {
      ...
      public void TestSPF()
      {
         ...
         Account account1 = SingletonProvider<TestSetup>.Instance.AddAccount(_domain, "spftest@test.com", "test");
         ...
         smtpClientSimulator.Send("spftest@openspf.org", account1.Address, "SPF test", "This is a test message.");
