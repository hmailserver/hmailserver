...
; OpenSSL
Source: "{#HMAILSERVERLIBS}\openssl-1.0.1k\out64\libeay32.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server;
Source: "{#HMAILSERVERLIBS}\openssl-1.0.1k\out64\ssleay32.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server;
