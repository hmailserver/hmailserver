...
Source: "Microsoft.VC120.CRT.x64\*"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server;
...
; OpenSSL
Source: "{#HMAILSERVERLIBS}\openssl-1.1.1c\out64\bin\libcrypto-1_1-x64.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "{#HMAILSERVERLIBS}\openssl-1.1.1c\out64\bin\libssl-1_1-x64.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
