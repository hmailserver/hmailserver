...
; OpenSSL
Source: "{#HMAILSERVERLIBS}\openssl-1.0.2o\out32\libeay32.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
Source: "{#HMAILSERVERLIBS}\openssl-1.0.2o\out32\ssleay32.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server admintools;
