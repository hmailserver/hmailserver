...
; OpenSSL
Source: "{#HMAILSERVERLIBS}\openssl-1.0.1o\out32\libeay32.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server;
Source: "{#HMAILSERVERLIBS}\openssl-1.0.1o\out32\ssleay32.dll"; DestDir: "{app}\Bin"; Flags: ignoreversion; Components: server;
