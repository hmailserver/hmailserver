                         ...
                         for ($i = 0; $i < $count; $i++)
                         {
                           ...
                           ?>
                            <tr>
                              ...
                              <?php
                                if($i > 0)
                                  echo "<a href=\"?page=background_rule_save&action=move&savetype=actionup&domainid=$domainid&accountid=$accountid&ruleid=$ruleid&actionid=$actionid\">$str_move_up</a>";
                                if($i < $count-1)
                                  echo "<a href=\"?page=background_rule_save&action=move&savetype=actiondown&domainid=$domainid&accountid=$accountid&ruleid=$ruleid&actionid=$actionid\">$str_move_down</a>";
                              ?>
                              </td>
                              <td><?php echo "<a href=\"?page=background_rule_save&savetype=action&action=delete&domainid=$domainid&accountid=$accountid&ruleid=$ruleid&actionid=$actionid\">$str_delete</a>";?></td>
                            </tr>                           
                           <?php
                         }
